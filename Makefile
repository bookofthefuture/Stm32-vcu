...
OBJSL		= $(BINARY).o hwinit.o stm32scheduler.o params.o terminal.o terminal_prj.o \
           my_string.o digio.o my_fp.o printf.o anain.o throttle.o isa_shunt.o Can_E46.o BMW_E65.o temp_meas.o Can_E39.o Can_VAG.o Can_OI.o MCP2515.o CANSPI.o \
           param_save.o errormessage.o stm32_can.o utils.o terminalcommands.o charger.o i3LIM.o chademo.o heater.o
